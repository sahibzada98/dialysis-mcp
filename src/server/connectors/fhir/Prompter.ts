...
export function buildPatientSummaryPrompt(data: any) {
...
export function buildMedicationReviewPrompt(data: any) {
...
export function buildConditionTimelinePrompt(data: any) {
...
export function buildLabTrendAnalysisPrompt(data: any) {
...
export function buildCareGapsPrompt(data: any) {
...
export function buildPreventiveCareReviewPrompt(data: any) {
...
export function buildChronicDiseaseManagementPrompt(data: any) {
...
export function buildRiskAssessmentPrompt(data: any) {
...
export function buildCareCoordinationPrompt(data: any) {
